...
class App(ctk.CTk):
    ...
    def _configure_window(self):
        # Set window dimensions to match the screen resolution
        window_width = 800  # Width of the 5-inch screen
        window_height = 480  # Height of the 5-inch screen
